...
ScriptTest.run("61_world_block: blockstate + light round-trip (lit copper bulb)", function(t) {
    ...
    var cell = Driver.world.block({ pos: { x: x, y: y, z: z } });
    ...
    for (var attempt = 0; attempt < 20; attempt++) {
        beside = Driver.world.block({ pos: { x: x + 1, y: y, z: z } });
...
ScriptTest.run("61_world_block: block-entity NBT via nbt:true", function(t) {
    ...
    var fill = Driver.invoke("mc.action.runCommand",
    ...
    var cell = Driver.world.block({ pos: { x: x, y: y, z: z }, nbt: true });
    ...
    var air = Driver.world.block({ pos: { x: x, y: y + 1, z: z }, nbt: true });
