...
/**
 * Loads YAML GameTest definitions from {@code data/worlddriver/gametests/}.
 *
 ...
 * in {@code WorldDriverCommon.runValidation()}. A YAML file is a top-level list
...
public final class YamlTestLoader {
    private static final String DIR = "/data/worlddriver/gametests/";
