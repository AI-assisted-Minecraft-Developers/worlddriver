 ...
 * the endpoint already owns the process). Set {@code -Dworlddriver.sandbox=on} to
...
public final class ScriptClassFilter {
    ...
    // Note: we don't deny our own net.magicterra.worlddriver.* classes. visibleToScripts
