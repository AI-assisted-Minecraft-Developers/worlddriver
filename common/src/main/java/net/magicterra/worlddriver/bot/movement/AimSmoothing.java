...
final class AimSmoothing {
    ...
    double freezeAnchorX, freezeAnchorZ;       // player pos when the frozen-press stall window opened (spinFreeze deadlock valve)
    ...
    float orbitWinding = 0;                     // the bot's own yaw turn accumulated over those ticks — an orbit winds past ORBIT_WINDING_DEG, a detour does not
