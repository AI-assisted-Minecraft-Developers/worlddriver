 ...
 * last-damager window, same one {@link net.magicterra.worlddriver.bot.combat.ThreatScanner}
 * and {@link net.magicterra.worlddriver.bot.ClientEventDetector} already lean on for
