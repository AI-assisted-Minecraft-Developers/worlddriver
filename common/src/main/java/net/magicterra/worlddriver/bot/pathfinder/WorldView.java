...
public interface WorldView {
     ...
     * {@link net.magicterra.worlddriver.bot.pathfinder.moves.SwimTraverseBreak}) price
     ...
     * {@link net.magicterra.worlddriver.bot.pathfinder.moves.WaterBucketFall} gates on this so A* never plans an MLG onto a
     ...
     * Used by the PARKOUR leaps (gated by {@link net.magicterra.worlddriver.bot.BotConfig#pathfinderForbidParkourIntoDeepWater})
     ...
     * break out ({@link net.magicterra.worlddriver.bot.pathfinder.moves.SwimBankClimbBreak})
