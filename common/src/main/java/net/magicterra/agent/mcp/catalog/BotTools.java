    ...
    public static List<Map<String, Object>> tools() {
        return List.of(
            ...
            wrTool("mc.bot.setting",
                ...
                "  pathfinderWaterClimbOutCost number       dflt 40     — PER-RISE g-cost when an edge climbs OUT of water onto a higher bank (water→dry, to.y>from.y; XZ goals only). A buoyant bot can't step onto a +1/+2 ledge without the Walker's bob-stuttery dig, so this biases A* toward the LOWEST exit (a surface-level bank = rise 0 = free) — tolerating a short detour over a tall climb-out (fixes 卡在土墙/反复挖同一土块/横跳 climb-out windows). Tall exits NOT forbidden; Goal.Block water arenas unaffected. 0=off\n" +
                ...
                object()
                    ...
                    .prop("pathfinderWaterClimbOutCost", number(0, 1000))
