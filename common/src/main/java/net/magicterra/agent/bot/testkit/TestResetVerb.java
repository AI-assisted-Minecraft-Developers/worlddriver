 ...
 * {@link #register()} is invoked from {@code AgentDriverCommon.ensureRpcUp}, once, immediately after
 ...
 * a headless server, and {@code ad.settingRegistryClosed} asserts the route + schema are present
