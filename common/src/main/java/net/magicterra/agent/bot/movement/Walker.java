...
public final class Walker {
    ...
    private final WalkerExpectAlarms exAlarms = new WalkerExpectAlarms();
    ...
    public Step tick(Avatar a, WorldView world) {
        ...
        if (BotConfig.walkerExpectAlarm) exAlarms.tick(a, world, p, path, step, noStepProgressTicks);
            ...
            if (wasFromEnd && path != null && step < path.size()) {
                ...
                if (!keepCurrent) {
                    if (BotConfig.walkerExpectAlarm && uTurnLeg) {
                        exAlarms.noteRepathFlip(pfTickCounter, foot);
                    }
        ...
        if (pillarRecoverLatch > 0 && pillarRecoverCell != null) {
            ...
            if (p.onGround()) {
                ...
                if (p.getY() >= pillarRecoverCell.getY() + 1.0) {
                    ...
                    exAlarms.notePlace(pillarRecoverCell);
                }
            }
            return Step.WALKING;
        }
