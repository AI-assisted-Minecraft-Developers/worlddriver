...
if (!clientAvailable()) {
    ...
    ScriptTest.run("28_construct: rejects missing mode", function(t) {
        ...
        var msg = null;
        try { Driver.invoke("mc.bot.construct", {}); } catch (e) { msg = String(e); }
    ...
    ScriptTest.run("28_construct: rejects unknown mode", function(t) {
        ...
        var msg = null;
        try { Driver.invoke("mc.bot.construct", { mode: "elevator" }); } catch (e) { msg = String(e); }
    ...
    ScriptTest.run("28_construct: tower rejects missing height/targetY", function(t) {
        var r = Driver.invoke("mc.bot.construct", { mode: "tower" });
    ...
    ScriptTest.run("28_construct: tower rejects oversize height", function(t) {
        ...
        var msg = null;
        try { Driver.invoke("mc.bot.construct", { mode: "tower", height: 9999 }); }
    ...
    ScriptTest.run("28_construct: bridge rejects missing distance", function(t) {
        var r = Driver.invoke("mc.bot.construct", { mode: "bridge", direction: "north" });
    ...
    ScriptTest.run("28_construct: bridge rejects oversize distance", function(t) {
        ...
        var msg = null;
        try {
            Driver.invoke("mc.bot.construct", { mode: "bridge", direction: "north", distance: 9999 });
        } catch (e) { msg = String(e); }
    ...
    ScriptTest.run("28_construct: bridge rejects unknown direction", function(t) {
        ...
        var msg = null;
        try {
            Driver.invoke("mc.bot.construct", { mode: "bridge", direction: "diagonalwise", distance: 4 });
        } catch (e) { msg = String(e); }
    ...
    ScriptTest.run("28_construct: schema-reject surfaces identically across in-JVM, RPC, MCP transports", function(t) {
        ...
        var direct = thrownMsg(function() { Driver.invoke("mc.bot.construct", args); });
        var viaTcp = thrownMsg(function() { Driver.system.rpcRoundtrip("mc.bot.construct", args); });
        var viaMcp = thrownMsg(function() { Driver.system.mcpRoundtrip("mc.bot.construct", args); });
