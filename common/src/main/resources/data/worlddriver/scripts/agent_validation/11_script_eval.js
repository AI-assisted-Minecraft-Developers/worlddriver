...
ScriptTest.run("11_script_eval: snippet can call Agent.invoke recursively", function(t) {
    var out = call("var v = Agent.invoke('mc.system.version', {}); v.modid");
    t.assertEqual(out.error, null);
    t.assertEqual(out.result, "worlddriver");
});

ScriptTest.run("11_script_eval: Agent.system / observe helpers are wired in the eval scope", function(t) {
