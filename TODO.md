...
| 🟡 判：已落，等回测（排练 #4 A/B 在跑） | J86 | 落点闸已在 HEAD（`f3b084e4`，`WalkerGeometry.hopSuppressed`，两个消费者一起改，`lethalDropWithinHopRange` 删除）。**释放侧已测量**（旧闸 131 次压制放行 129，77 次放行一次不新增压制）；**防死侧无样本**，靠两处反算，等真场合自己归档。判据 `rehearse4-ab-criteria.md` | 我 |
