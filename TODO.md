...
| 🔴 判：查 | J108 | 换柱时 `shaft.reColumn.1.upstream` 已经印出 29 个水源并写明「换到的下一根柱子若离得不够远会淹在同一片水里」，而换到的 `-10,51` 一带确实还是同一片水（脚下柱理由=「邻柱地表是水」）。**那行已经把正确判据写出来了，只是没人拿它当选柱输入** | 我 |
...
| 🟤 判：押后（等 J106） | J105 | 被盖住且横向无路时开火太晚：气 100 开火只剩约 300 tick，破盖要 379。抬到 240 得约 440——但满血才勉强赢，10 血又输。**若 J106 成立则 379→~76，这条不必做**；两笔都做等于给同一个病开两副药 | 我 |
