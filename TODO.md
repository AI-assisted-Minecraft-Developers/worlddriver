...
| 🟠 判：做（等第 11 趟验 `finishTheBite`，再决定挂不挂 11/12 级） | J84 | **12 级整级挨饿**（第 7 趟饱食 0、第 9 趟 1、第 10 趟 0）。`JourneyFeed` 只接在 10 级砾石那一步 ⇒ 11、12 级没有任何进食机会。⛔ 在 10 级那一口被证明真能喂饱之前，不要去 11/12 级挂第二条同样吃不下去的腿。判据 `feed-finish-criteria.md` | 我 |
