...
| 🟠 判：先补测量（`raiseVeto` 已在 HEAD，等第 11 趟读它） | J85 | **12 级连三趟都倒在第 9 格**（第 7/9/10 趟；那是全环最高一格，壁龛地板 y=56 而它在 y=61）。第 9 趟是塔被自己浇的水源冲下，第 10 趟是三条抬升腿都够到了高度、**都停在别的柱**（`water8.raisedY=60/60（停在 -1,20，指定柱 3,20）`）⇒ 不是同一族，⛔ 别按单趟认因。⛔ 不许加第五道补救腿。三态判据在 `ladder9-verdict.md` | 我 |
