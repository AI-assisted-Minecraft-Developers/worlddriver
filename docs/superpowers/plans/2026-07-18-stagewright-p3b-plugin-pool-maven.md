...
- `stagewrightServer`（loader=L）：`python3 scripts/stagewright/t0.py --loader L --run-task :L:runDogfoodServer --results L/run-dogfood/stagewright-results.jsonl --expect-file scripts/stagewright/expected-scenes-L.txt`
