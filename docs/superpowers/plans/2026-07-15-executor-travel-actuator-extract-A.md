...
> Unit 1 (scaffolding, commit 53ce8de) STANDS. This plan replaces the "migrate stepUp" units.
...
- Reference line numbers are as of commit 53ce8de and DRIFT after each slice — always grep current.
