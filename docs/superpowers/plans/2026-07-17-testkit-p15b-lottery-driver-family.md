...
Run: `python3 scripts/stagewright/t0.py --loader neoforge --wall 540 --run-task :neoforge:runDogfoodServer --results neoforge/run-dogfood/testkit-results.jsonl --expect-file scripts/stagewright/expected-scenes-neoforge.txt; echo "exit=$?"`
...
Run: `./gradlew :stagewright-common:compileJava :neoforge:compileJava -q && python3 scripts/stagewright/t0.py --loader neoforge --wall 540 --run-task :neoforge:runDogfoodServer --results neoforge/run-dogfood/testkit-results.jsonl --expect-file scripts/stagewright/expected-scenes-neoforge.txt; echo "exit=$?"`
...
Run: `python3 scripts/stagewright/t0.py --loader neoforge --wall 540 --run-task :neoforge:runDogfoodServer --results neoforge/run-dogfood/testkit-results.jsonl --expect-file scripts/stagewright/expected-scenes-neoforge.txt && python3 scripts/stagewright/t0.py --loader neoforge --wall 540; echo "exit=$?"`
