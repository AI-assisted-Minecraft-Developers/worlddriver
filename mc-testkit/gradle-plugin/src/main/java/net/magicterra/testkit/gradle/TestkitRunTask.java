 ...
 * built in {@link TestkitPlugin}), runs it with {@link ExecOperations} streaming the
 ...
 * verdict authority.
 */
public abstract class TestkitRunTask extends DefaultTask {
    ...
    @Inject
    public TestkitRunTask(ExecOperations execOps) {
