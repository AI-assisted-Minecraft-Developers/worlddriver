 ...
 *   <li>The three orchestrator tasks (testkitServer/testkitClient/testkitE2E) are
 *       unaffected in both flag states.</li>
 * </ul>
 */
class TestkitTestmodSourceSetFunctionalTest {
    ...
    void orchestratorTasksUnaffectedFlagOff() throws IOException {
        writeSettings();
        writeBuildGradle("plugins { id 'java'; id 'net.magicterra.mc-testkit' }\n");
