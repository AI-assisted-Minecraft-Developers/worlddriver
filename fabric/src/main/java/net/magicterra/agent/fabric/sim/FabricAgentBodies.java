package net.magicterra.agent.fabric.sim;
...
import net.magicterra.agent.bot.sim.AgentFakePlayer;
 ...
 *       {@code AgentDriverFabric}). NeoForge fires unloadLevel from its own level-unload hook;
 ...
 * (scene ticks via {@code TestkitCommon.onServerTick}, the {@code /agentserver} command, and
