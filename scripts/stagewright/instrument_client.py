#!/usr/bin/env python3
"""worlddriver's gate entry point for StageWright's client instrument runner.

The orchestrators and their siblings moved to the StageWright repo when it was split out; this shim keeps the
documented `python scripts/stagewright/instrument_client.py ...` commands working unchanged.
...
TARGET = os.path.join(HOME, "scripts", "instrument_client.py")
