#!/usr/bin/env python3
"""worlddriver's gate entry point for StageWright's t1 orchestrator.

The orchestrators moved to the StageWright repo when it was split out; this shim keeps the
documented `python scripts/stagewright/t1.py ...` commands working unchanged.
...
TARGET = os.path.join(HOME, "scripts", "t1.py")
