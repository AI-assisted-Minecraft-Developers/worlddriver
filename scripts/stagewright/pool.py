#!/usr/bin/env python3
"""worlddriver's gate entry point for StageWright's process pool.

The orchestrators and their siblings moved to the StageWright repo when it was split out; this shim keeps the
documented `python scripts/stagewright/pool.py ...` commands working unchanged.
...
TARGET = os.path.join(HOME, "scripts", "pool.py")
