#!/usr/bin/env python3
"""event_tail.py — stream live agent-driver game events, one compact line per event.
...
TUNE (env):
  ...
  AGENT_RPC_PORT / AGENT_RPC_HOST  override (else rpc.py finds fabric/run/agent-rpc.port).
"""
import asyncio
import json
import os
